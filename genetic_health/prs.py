...
PRS_MODELS = {
    ...
    "systemic_lupus": {
        ...
        "snps": [
            {"rsid": "rs2476601", "risk_allele": "A", "log_or": 0.262, "gene": "PTPN22", "eur_freq": 0.100},
            {"rsid": "rs7574865", "risk_allele": "T", "log_or": 0.262, "gene": "STAT4", "eur_freq": 0.230},
            {"rsid": "rs10488631", "risk_allele": "C", "log_or": 0.336, "gene": "IRF5", "eur_freq": 0.100},
            {"rsid": "rs2736340", "risk_allele": "T", "log_or": 0.182, "gene": "BLK", "eur_freq": 0.260},
            {"rsid": "rs6568431", "risk_allele": "A", "log_or": 0.148, "gene": "TNFAIP3", "eur_freq": 0.250},
            {"rsid": "rs4917014", "risk_allele": "T", "log_or": 0.131, "gene": "IKZF2", "eur_freq": 0.310},
            {"rsid": "rs2431098", "risk_allele": "T", "log_or": 0.113, "gene": "PRDM1/ATG5", "eur_freq": 0.430},
            {"rsid": "rs849142", "risk_allele": "T", "log_or": 0.131, "gene": "JAZF1", "eur_freq": 0.240},
            {"rsid": "rs1913517", "risk_allele": "T", "log_or": 0.113, "gene": "TNFSF4", "eur_freq": 0.240},
            {"rsid": "rs10516487", "risk_allele": "G", "log_or": 0.148, "gene": "BANK1", "eur_freq": 0.290},
            {"rsid": "rs2269368", "risk_allele": "T", "log_or": 0.095, "gene": "RELN", "eur_freq": 0.210},
            {"rsid": "rs4963128", "risk_allele": "C", "log_or": 0.095, "gene": "UHRF1BP1", "eur_freq": 0.380},
        ],
    },
    ...
    "multiple_sclerosis": {
        ...
        "snps": [
            {"rsid": "rs3135388", "risk_allele": "A", "log_or": 0.588, "gene": "HLA-DRB1*15:01 tag", "eur_freq": 0.130},
            {"rsid": "rs6897932", "risk_allele": "C", "log_or": 0.182, "gene": "IL7R", "eur_freq": 0.240},
            {"rsid": "rs12722489", "risk_allele": "G", "log_or": 0.182, "gene": "IL2RA", "eur_freq": 0.150},
            {"rsid": "rs2104286", "risk_allele": "T", "log_or": 0.148, "gene": "IL2RA", "eur_freq": 0.250},
            {"rsid": "rs6677309", "risk_allele": "C", "log_or": 0.113, "gene": "CD58", "eur_freq": 0.210},
            {"rsid": "rs4648356", "risk_allele": "C", "log_or": 0.095, "gene": "EVI5", "eur_freq": 0.330},
            {"rsid": "rs12487066", "risk_allele": "G", "log_or": 0.095, "gene": "TNFRSF1A", "eur_freq": 0.390},
            {"rsid": "rs703842", "risk_allele": "A", "log_or": 0.113, "gene": "CYP27B1 (VitD)", "eur_freq": 0.330},
            {"rsid": "rs10492972", "risk_allele": "C", "log_or": 0.095, "gene": "KIF21B", "eur_freq": 0.250},
            {"rsid": "rs1800693", "risk_allele": "C", "log_or": 0.095, "gene": "TNFRSF1A", "eur_freq": 0.410},
            {"rsid": "rs2300747", "risk_allele": "A", "log_or": 0.078, "gene": "CD48", "eur_freq": 0.300},
            {"rsid": "rs1077667", "risk_allele": "T", "log_or": 0.078, "gene": "TNFSF14", "eur_freq": 0.270},
        ],
    },
    ...
    "hashimotos_thyroiditis": {
        ...
        "snps": [
            {"rsid": "rs3184504", "risk_allele": "T", "log_or": 0.182, "gene": "SH2B3", "eur_freq": 0.480},
            {"rsid": "rs2476601", "risk_allele": "A", "log_or": 0.262, "gene": "PTPN22", "eur_freq": 0.100},
            {"rsid": "rs3087243", "risk_allele": "G", "log_or": 0.182, "gene": "CTLA4", "eur_freq": 0.540},
            {"rsid": "rs965513", "risk_allele": "A", "log_or": 0.336, "gene": "FOXE1", "eur_freq": 0.350},
            {"rsid": "rs2517532", "risk_allele": "G", "log_or": 0.148, "gene": "HLA-A", "eur_freq": 0.200},
            {"rsid": "rs7528684", "risk_allele": "A", "log_or": 0.113, "gene": "FCRL3", "eur_freq": 0.430},
            {"rsid": "rs1990760", "risk_allele": "T", "log_or": 0.113, "gene": "IFIH1", "eur_freq": 0.610},
            {"rsid": "rs179247", "risk_allele": "A", "log_or": 0.131, "gene": "TSHR", "eur_freq": 0.390},
            {"rsid": "rs4411998", "risk_allele": "C", "log_or": 0.095, "gene": "VAV3", "eur_freq": 0.310},
            {"rsid": "rs3094228", "risk_allele": "C", "log_or": 0.095, "gene": "PSORS1C1", "eur_freq": 0.220},
        ],
    },
    ...
    "psoriasis": {
        ...
        "snps": [
            {"rsid": "rs10484554", "risk_allele": "T", "log_or": 0.588, "gene": "HLA-C*06:02 tag", "eur_freq": 0.100},
            {"rsid": "rs4406273", "risk_allele": "A", "log_or": 0.405, "gene": "HLA-C", "eur_freq": 0.120},
            {"rsid": "rs3213094", "risk_allele": "T", "log_or": 0.182, "gene": "IL12B", "eur_freq": 0.240},
            {"rsid": "rs2201841", "risk_allele": "T", "log_or": 0.148, "gene": "IL23R", "eur_freq": 0.330},
            {"rsid": "rs610604", "risk_allele": "A", "log_or": 0.131, "gene": "TNFAIP3", "eur_freq": 0.340},
            {"rsid": "rs12188300", "risk_allele": "T", "log_or": 0.182, "gene": "IL12B", "eur_freq": 0.180},
            {"rsid": "rs8016947", "risk_allele": "G", "log_or": 0.131, "gene": "TRAF3IP2", "eur_freq": 0.410},
            {"rsid": "rs11795343", "risk_allele": "T", "log_or": 0.095, "gene": "IL23A", "eur_freq": 0.380},
            {"rsid": "rs240993", "risk_allele": "A", "log_or": 0.095, "gene": "REV3L", "eur_freq": 0.270},
            {"rsid": "rs1990760", "risk_allele": "T", "log_or": 0.078, "gene": "IFIH1", "eur_freq": 0.610},
            {"rsid": "rs2546890", "risk_allele": "A", "log_or": 0.095, "gene": "IL12B", "eur_freq": 0.490},
            {"rsid": "rs4112788", "risk_allele": "C", "log_or": 0.131, "gene": "LCE3B-LCE3C", "eur_freq": 0.330},
        ],
    },
    ...
    "gout": {
        ...
        "snps": [
            {"rsid": "rs2231142", "risk_allele": "T", "log_or": 0.405, "gene": "ABCG2 (urate)", "eur_freq": 0.110},
            {"rsid": "rs12498742", "risk_allele": "A", "log_or": 0.262, "gene": "SLC2A9 (GLUT9)", "eur_freq": 0.240},
            {"rsid": "rs1183201", "risk_allele": "T", "log_or": 0.182, "gene": "SLC17A1", "eur_freq": 0.340},
            {"rsid": "rs1165151", "risk_allele": "T", "log_or": 0.131, "gene": "SLC17A3", "eur_freq": 0.450},
            {"rsid": "rs3775948", "risk_allele": "G", "log_or": 0.148, "gene": "SLC22A11", "eur_freq": 0.320},
            {"rsid": "rs1260326", "risk_allele": "T", "log_or": 0.095, "gene": "GCKR", "eur_freq": 0.410},
            {"rsid": "rs2078267", "risk_allele": "C", "log_or": 0.113, "gene": "SLC22A12", "eur_freq": 0.270},
            {"rsid": "rs7442295", "risk_allele": "A", "log_or": 0.095, "gene": "RREB1", "eur_freq": 0.210},
            {"rsid": "rs17300741", "risk_allele": "G", "log_or": 0.095, "gene": "SLC2A9", "eur_freq": 0.730},
            {"rsid": "rs675209", "risk_allele": "T", "log_or": 0.113, "gene": "ABCG2", "eur_freq": 0.150},
        ],
    },
    ...
    "gallstones": {
        ...
        "snps": [
            {"rsid": "rs11887534", "risk_allele": "G", "log_or": 0.588, "gene": "ABCG8 (D19H)", "eur_freq": 0.090},
            {"rsid": "rs4245791", "risk_allele": "T", "log_or": 0.336, "gene": "ABCG8", "eur_freq": 0.200},
            {"rsid": "rs1800961", "risk_allele": "T", "log_or": 0.262, "gene": "HNF4A", "eur_freq": 0.040},
            {"rsid": "rs6471717", "risk_allele": "C", "log_or": 0.182, "gene": "TM4SF4", "eur_freq": 0.280},
            {"rsid": "rs9843304", "risk_allele": "T", "log_or": 0.131, "gene": "CYP7A1", "eur_freq": 0.340},
            {"rsid": "rs2290846", "risk_allele": "C", "log_or": 0.113, "gene": "SULT2A1", "eur_freq": 0.280},
            {"rsid": "rs1260326", "risk_allele": "T", "log_or": 0.078, "gene": "GCKR", "eur_freq": 0.410},
            {"rsid": "rs7805747", "risk_allele": "A", "log_or": 0.095, "gene": "PRKAG2", "eur_freq": 0.260},
            {"rsid": "rs6984305", "risk_allele": "G", "log_or": 0.095, "gene": "FARP2", "eur_freq": 0.330},
            {"rsid": "rs12473643", "risk_allele": "T", "log_or": 0.078, "gene": "SLC10A2", "eur_freq": 0.370},
        ],
    },
}
